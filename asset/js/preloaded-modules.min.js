    ...
    5914: (e, t) => {
      ...
      class ImageCarousel extends elementorModules.frontend.handlers.SwiperBase {
        ...
        getSwiperSettings() {
          ...
          return (
            r && (o.navigation = { prevEl: ".elementor-swiper-button-prev", nextEl: ".elementor-swiper-button-next" }),
            l && (o.pagination = { el: ".swiper-pagination", type: "bullets", clickable: !0 }),
            o
          );
        }
        async onInit(...e) {
      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        getDefaultSettings: function () {
          return {
            ...
            selectors: {
              ...
              slideshow: { activeSlide: ".swiper-slide-active", prevSlide: ".swiper-slide-prev", nextSlide: ".swiper-slide-next" },
            },
        ...
        setVideoContent: function (e) {
          ...
          if ("hosted" === e.videoType) {
            ...
            -1 !== e.url.indexOf("vimeo.com")
              ...
              : e.url.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (s = elementorFrontend.utils.youtube),
        ...
        activateZoom: function () {
          ...
          e.zoom.in(),
            ...
            t.$iconZoom.removeClass(s.slideshow.iconZoomIn).addClass(s.slideshow.iconZoomOut);
        },
        deactivateZoom: function () {
          ...
          e.zoom.out(),
            ...
            t.$iconZoom.removeClass(s.slideshow.iconZoomOut).addClass(s.slideshow.iconZoomIn);
        },
