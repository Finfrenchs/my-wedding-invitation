...
jQuery(document).ready(function (i) {
  ...
  jQuery(document).ready(function (o) {
    o("[data-pafe-ajax-live-search]").each(function () {
      ...
      t.append('<div class="pafe-ajax-live-search-results" data-pafe-ajax-live-search-results></div><input type="hidden" name="post_type" value="' + e + '">'),
        t.find(".elementor-search-form__input").attr("autocomplete", "off");
    });
    var a = null;
        ...
        .each(function () {
          ...
          $form.find('[name^="form_fields"]').each(function () {
            if (null != $(this).attr("id")) {
              ...
              if (
                (0 < i.length &&
                  (null == (t = "radio" == s || "checkbox" == s ? $form.find('[name="form_fields[' + e + ']"]:checked').val() : i.val().trim()) ? (t = 0) : ((t = parseInt(t)), isNaN(t) && (t = 0)),
                  (window[e] = parseInt(t))),
                -1 !== e.indexOf("[]"))
              ) {
                e = e.replace("[]", "");
          ...
          for (var i = 0; i < calculations.length; i++) {
            ...
            0 < $totalField.length &&
              ...
              (totalFieldContent =
                calculations[i].pafe_calculated_fields_form_before + eval(calculations[i].pafe_calculated_fields_form_calculation) + calculations[i].pafe_calculated_fields_form_after),
              $totalField.hide(),
        ...
        .each(function () {
          ...
          u.find('[name^="form_fields"]').each(function () {
            if (null != b(this).attr("id")) {
              for (
                var t = b(this).closest(".elementor-field-group"), e = b(this).attr("name").replace("[]", "").replace("form_fields[", "").replace("]", ""), i = 0, s = 0, o = "", a = 0;
                a < v.length;
                a++
              ) {
              ...
              "or" == o && (i < s ? (0 < m ? t.show() : t.slideDown(_, g)) : 0 < m ? t.hide() : t.slideUp(_, g)),
                "and" == o && (0 == i ? (0 < m ? t.show() : t.slideDown(_, g)) : 0 < m ? t.hide() : t.slideUp(_, g));
            }
          });
  ...
  jQuery(document).ready(function (a) {
    ...
    a("[data-pafe-crossfade-multiple-background-images]").each(function () {
      for (
        var t = a(this).data("pafe-crossfade-multiple-background-images").split(","),
          e = a(this).data("pafe-crossfade-multiple-background-images-speed"),
          i = a(this).data("pafe-crossfade-multiple-background-images-speed-fadeout"),
          s = 0;
        s < t.length;
        s++
      ) {
      ...
      c("[data-pafe-equal-height-for-woocommerce-products]").each(function () {
        ...
        if ((e.find(".woocommerce-loop-product__title").height("auto"), 0 < e.length && 0 < i))
          for (var s = Math.ceil(e.length / i), o = 0; o < s; o++) {
            for (var a = [], n = [], r = o * i; r < (o + 1) * i; r++)
              a.push(e.eq(r).find(".woocommerce-loop-product__title").height()), n.push(e.eq(r).find(".attachment-woocommerce_thumbnail").height());
  ...
  jQuery(document).ready(function (n) {
    ...
    n(document).on("keyup change", '[data-pafe-form-abandonment].elementor-widget-form [name^="form_fields"]', function () {
        ...
        localStorage[t] &&
          ...
          e.each(function () {
            ...
            "radio" == t
              ...
              : "checkbox" == t
              ? void 0 !== i[e] &&
                (n(this).attr("name").includes("[]") ? i[e].includes(n(this).attr("value")) && n(this).prop("checked", !0) : n(this).attr("value") == i[e] && n(this).prop("checked", !0))
      ...
      n(document).on("submit_success", function (t, e) {
        ...
        var s,
          o = 0 < i.length && i.attr("data-pafe-form-abandonment-webhook"),
        ...
        localStorage[a] &&
          ...
          t.append("fields", JSON.stringify(s)),
      ...
      n(document).on("click", "[data-pafe-form-builder-trigger-success]", function () {
        ...
        var e,
          i,
          s = 0 < t.length && t.attr("data-pafe-form-abandonment-webhook"),
          o = "pafe-form-abandonment-" + n(this).attr("data-pafe-form-builder-trigger-success");
        localStorage[o] &&
          ((e = JSON.parse(localStorage.getItem(o))),
          (i = new FormData()).append("action", "pafe_form_abandonment"),
          i.append("fields", JSON.stringify(e)),
          i.append("form_type", "PAFE Form"),
          i.append("function", "success"),
          i.append("webhook", s),
          navigator.sendBeacon(n("[data-pafe-ajax-url]").data("pafe-ajax-url"), i),
      ...
      n(window).on("blur beforeunload", function (t) {
        ...
        (o = t.type),
          n("[data-pafe-form-abandonment].elementor-widget-form .elementor-form").each(function () {
            ...
            "blur" == o && (e = !1);
            var i,
              s = "pafe-form-abandonment-" + n(this).attr("name");
            localStorage[s] &&
              ((i = JSON.parse(localStorage.getItem(s))),
              (s = new FormData()).append("action", "pafe_form_abandonment"),
              s.append("fields", JSON.stringify(i)),
              s.append("form_type", "Elementor Form"),
              s.append("function", "abandonment"),
              s.append("webhook", e),
              navigator.sendBeacon(n("[data-pafe-ajax-url]").data("pafe-ajax-url"), s));
          }),
          n("[data-pafe-form-abandonment] [data-pafe-form-builder-submit-form-id]").each(function () {
            let t = n("[data-pafe-form-abandonment-webhook]"),
              e = 0 < t.length && t.attr("data-pafe-form-abandonment-webhook");
            "blur" == o && (e = !1);
            var i,
              s = "pafe-form-abandonment-" + n(this).attr("data-pafe-form-builder-submit-form-id");
            localStorage[s] &&
              ((i = JSON.parse(localStorage.getItem(s))),
              (s = new FormData()).append("action", "pafe_form_abandonment"),
              s.append("fields", JSON.stringify(i)),
              s.append("form_type", "PAFE Form"),
              s.append("function", "abandonment"),
              s.append("webhook", e),
              navigator.sendBeacon(n("[data-pafe-ajax-url]").data("pafe-ajax-url"), s));
          });
    ...
    g(document).on("submit", "[data-pafe-form-google-sheets-connector] form", function () {
      ...
      for (var n = 0; n < Math.max.apply(null, s) + 1; n++) {
        for (var r = "", o = 0; o < i.length; o++) {
          ...
          if (n == v(i[o].pafe_form_google_sheets_connector_field_column)) for (var h = 0; h < a.length; ++h) a[h].name == l && (r = a[h].value);
        }
        e += '"' + r + '",';
      }
      e = e.slice(0, -1);
      var c = t.data("pafe-form-google-sheets-connector"),
        ...
        u =
          ...
          c +
          "/values/" +
          t.data("pafe-form-google-sheets-connector-tab") +
          "A1:append?includeValuesInResponse=false&insertDataOption=INSERT_ROWS&responseDateTimeRenderOption=SERIAL_NUMBER&responseValueRenderOption=FORMATTED_VALUE&valueInputOption=USER_ENTERED",
        m = '{"majorDimension":"ROWS", "values":[[' + e + "]]}",
        _ = new XMLHttpRequest();
      _.open("POST", "https://www.googleapis.com/oauth2/v4/token?client_id=" + d + "&client_secret=" + p + "&refresh_token=" + f + "&grant_type=refresh_token"),
        _.setRequestHeader("Content-type", "application/x-www-form-urlencoded"),
        (_.onload = function () {
          var t,
            e = JSON.parse(_.responseText).access_token;
          e &&
            ((t = new XMLHttpRequest()).open("POST", u),
            t.setRequestHeader("Content-length", m.length),
            t.setRequestHeader("Content-type", "application/json"),
            t.setRequestHeader("Authorization", "OAuth " + e),
            t.send(m));
        }),
        _.send();
    });
  ...
  jQuery.fn.extend({
      ...
      },
      {
        ...
        value: function (o, t) {
          for (var e, i, s, a, n, r, l, h, c = 0, d = (r = o.children("optgroup")).length; c < d; c++)
            (n = r[c]),
              (n = jQuery(n)),
              (e = jQuery("<ul></ul>")).append(jQuery("<li class='group_title'>" + n.attr("label") + "</li>")),
              t.append(jQuery("<li class='group'>").append(e)),
              this.recursively_parse_option_groups(n, e);
          for (
            h = [],
              i = 0,
              s = (l = function () {
    ...
    _createClass(o, [
      ...
      },
      {
        key: "clicked",
        value: function (t) {
          if ((this.picker.toggle(this, t), null != this.opts.clicked && this.opts.clicked.call(this.picker.select, this, t), null != this.opts.selected && this.is_selected()))
            return this.opts.selected.call(this.picker.select, this, t);
        },
      },
      {
        key: "create_node",
        value: function () {
          ...
          return (
            ...
            this.option.data("font_awesome")
              ? (t = jQuery("<i>")).attr("class", "fa-fw " + this.option.data("img-src"))
              : (t = jQuery("<img class='image_picker_image'/>")).attr("src", this.option.data("img-src")),
  ...
  (function (o, a, n, s) {
    ...
    (o.fn.pafeParallax = function (i) {
      return this.each(function () {
        var t = o(this),
          e = "object" == typeof i && i;
        this == a || this == n || t.is("body")
          ? r.configure(e)
          : t.data("px.pafeParallax")
          ? "object" == typeof i && o.extend(t.data("px.pafeParallax"), e)
          : ((e = o.extend({}, t.data(), e)), t.data("px.pafeParallax", new r(this, e))),
  ...
  (function (e) {
    ...
    (o.prototype = {
      ...
      pointerFocus: function (t) {
        var e, i;
        this.target ||
          ((e = (i = "single" === this.options.type ? this.$cache.single : this.$cache.from).offset().left),
          (e += i.width() / 2 - 1),
          this.pointerClick("single", { preventDefault: function () {}, pageX: e }));
      },
      ...
      checkMinInterval: function (t, e, i) {
        ...
        return o.min_interval
          ? ((s = this.convertToValue(t)),
            ...
            "from" === i ? e - s < o.min_interval && (s = e - o.min_interval) : s - e < o.min_interval && (s = e + o.min_interval),
      ...
      checkMaxInterval: function (t, e, i) {
        ...
        return o.max_interval
          ? ((s = this.convertToValue(t)),
            (e = this.convertToValue(e)),
            "from" === i ? e - s > o.max_interval && (s = e - o.max_interval) : s - e > o.max_interval && (s = e + o.max_interval),
            this.convertToPercent(s))
          : t;
      },
      ...
      validate: function () {
        ...
        if (
          ...
          for (i.p_values = [], i.min = 0, i.max = a - 1, i.step = 1, i.grid_num = i.max, i.grid_snap = !0, e = 0; e < a; e++)
            (t = +o[e]), (t = isNaN(t) ? o[e] : ((o[e] = t), this._prettify(t))), i.p_values.push(t);
      ...
      appendGrid: function () {
        if (this.options.grid) {
          var t,
            ...
            d = "";
          for (
            this.calcGridMargin(), n.grid_snap && (l = r / n.step), 50 < l && (l = 50), i = this.toFixed(100 / l), 4 < l && (c = 3), 7 < l && (c = 2), 14 < l && (c = 1), 28 < l && (c = 0), t = 0;
            t < l + 1;
            t++
          ) {
      ...
      calcGridCollision: function (t, e, i) {
        for (var s, o, a = this.coords.big_num, n = 0; n < a && !(a <= (s = n + t / 2)); n += t)
          (o = this.$cache.grid_labels[s][0]), i[n] <= e[s] ? (o.style.visibility = "visible") : (o.style.visibility = "hidden");
      },
      ...
      jQuery(document).on("elementor/popup/show", function () {
        m("[data-pafe-range-slider]").each(function () {
          if ("popup" == m(this).closest("[data-elementor-type]").attr("data-elementor-type"))
            for (var t = m(this).data("pafe-range-slider"), e = 0; e < t.length; e++) {
              for (
                var i = m(this).find('[name="form_fields[' + t[e].pafe_range_slider_field_custom_id + ']"]'), s = {}, o = t[e].pafe_range_slider_field_options.split(","), a = 0;
                a < o.length;
                a++
              ) {
                var n,
  ...
  (function (t, e) {
    ...
    t.prototype = {
        ...
        i
          ...
          : ((this.wrapper = i =
            ...
            f.on("scroll" + u, function (t) {
              g.isFunction(m.onScroll) &&
                m.onScroll.call(
                  p,
                  { maxScroll: _.y.maxScrollOffset, scroll: f.scrollTop(), size: _.y.size, visible: _.y.visible },
                  { maxScroll: _.x.maxScrollOffset, scroll: f.scrollLeft(), size: _.x.size, visible: _.x.visible }
                ),
          ...
          g.each(_, function (t, e) {
            g.extend(
              e,
              "x" == t
                ? { offset: parseInt(f.css("left"), 10) || 0, size: f.prop("scrollWidth"), visible: i.width() }
                : { offset: parseInt(f.css("top"), 10) || 0, size: f.prop("scrollHeight"), visible: i.height() }
            );
          }),
          ...
          g.each(_, function (t, e) {
            ...
            m.autoScrollSize && ((e.scrollbarSize = parseInt((i * a) / t, 10)), e.scroll.bar.css(o, e.scrollbarSize + "px")),
              (e.scrollbarSize = e.scroll.bar[s]()),
              (e.kx = (i - e.scrollbarSize) / (t - a) || 1),
              (e.maxScrollOffset = t - a);
          }),
      ...
      _getScroll: function (t) {
        ...
        return (
          e[t] && (t = e[t]),
          (t = "string" == typeof (t = t || e.simple) ? g(t).appendTo(this.wrapper) : g(t)),
          g.extend(t, { bar: t.find(".scroll-bar"), size: t.find(".scroll-element_size"), track: t.find(".scroll-element_track") }),
          t
        );
      },
      ...
      _updateScroll: function (t, e) {
        ...
        (e.isVisible = 1 < l - n),
          ...
          (e.size == i.prop("scrollWidth") &&
            a.size == i.prop("scrollHeight") &&
            e.visible == r.width() &&
            a.visible == r.height() &&
            e.offset == (parseInt(i.css("left"), 10) || 0) &&
  ...
  jQuery(document).ready(function (e) {
    e(document).on("click", "[data-pafe-section-link]", function () {
      var t = e(this).data("pafe-section-link"),
        t =
          "on" == e(this).data("pafe-section-link-external")
            ? '<a href="' + t + '" target="_blank" data-pafe-section-link-a style="display:none"></a>'
            : '<a href="' + t + '" data-pafe-section-link-a style="display:none"></a>';
