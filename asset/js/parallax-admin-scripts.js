  ...
  var e = {
      807: function () {
        !(function (e, t) {
          ...
          var n = {
            init: function () {
              t.hooks.addAction("frontend/element_ready/section", n.elementorSection);
            },
          ...
          var i = function (n) {
            ...
            (i.init = function () {
              return e(window).width() <= 1024 || (i.setParallaxMulti(o), i.moveBg(o)), !1;
            }),
              (i.setParallaxMulti = function (t) {
                ...
                if (((a = i.getOptions(t, "ekit_section_parallax_multi_items")), "yes" == (o = i.getOptions(t, "ekit_section_parallax_multi")))) {
                  ...
                  if (
                    (n.addClass("elementskit-parallax-multi-container"),
              ...
              (i.moveBg = function (e) {
                var t, o;
                (t = i.getOptions(e, "ekit_section_parallax_bg")),
                  (o = i.getOptions(e, "ekit_section_parallax_bg_speed")),
                  n.addClass("elementskit-parallax-multi-container"),
                  "yes" != t || s || n.jarallax({ speed: o });
              }),
              (i.walkItem = function (t) {
                t.parallax_transform !== undefined &&
                  t.parallax_transform_value !== undefined &&
                  n.find(".elementor-repeater-item-" + t._id).imagesLoaded(function () {
                    e(this.elements[0]).magician({
                      ...
                      animation: { [t.parallax_transform]: t.parallax_transform_value },
                    });
                  });
              }),
              (i.moveItem = function (e, t) {
                ...
                TweenMax.to(s, 1, { x: ((i - n.width() / 2) / n.width()) * e.parallax_speed, y: ((o - n.height() / 2) / n.height()) * e.parallax_speed, ease: Power2.ease });
              }),
              ...
              (i.pushElement = function (e) {
                ...
                "shape" == e.item_source &&
                  ((e.image = {}),
                  (e.image.url = window.elementskit_module_parallax_url + "assets/svg/" + e.shape + ".svg"),
                  (t += " ekit-section-parallax-layer-shape"),
                  (i = "shape-" + e.shape.replace(".svg", ""))),
                  0 === n.find(".elementor-repeater-item-" + e._id).length &&
                    "" != e.image.url &&
                    n.prepend(
      ...
      545: function () {
        !(function (e, t) {
          ...
          var i =
              "undefined" != typeof window.elementorFrontend.version &&
              (function (e, t) {
              ...
              })(window.elementorFrontend.version, "2.6.0") < 0
            ...
            o = i.extend({
              ...
              deactivate: function (t) {
                (t || !this.getElementSettings("ekit_we_effect_on") || "tilt" != this.getElementSettings("ekit_we_effect_on") || this.isTrue("ekit_we_on_test_mode", "yes")) &&
                  this.$element.find(".elementor-widget-container").tilt().tilt.destroy.call(this.$element.find(".elementor-widget-container")),
                  (t || !this.getElementSettings("ekit_we_effect_on") || "mousemove" != this.getElementSettings("ekit_we_effect_on") || this.isTrue("ekit_we_on_test_mode", "yes")) &&
                    this.$element.parents(".elementor-section").first().off("mousemove.elementskitwidgethovereffect"),
                  (t || !this.getElementSettings("ekit_we_effect_on") || "onscroll" != this.getElementSettings("ekit_we_effect_on") || this.isTrue("ekit_we_on_test_mode", "yes")) &&
                    e(window).off("scroll.magicianscrolleffect" + this.getID());
              },
              ...
              mousemove: function () {
                ...
                t.on("mousemove.elementskitwidgethovereffect", function (i) {
                  ...
                  TweenMax.to(e, 1, { x: ((o - t.width() / 2) / t.width()) * n, y: ((s - t.height() / 2) / t.height()) * n, ease: Power2.ease });
                });
              },
              onscroll: function () {
                this.$element
                  ...
                  .magician({
                    ...
                    animation: { [this.getElementSettings("ekit_we_scroll_animation")]: this.getElementSettings("ekit_we_scroll_animation_value") },
                  });
              },
            });
        })(jQuery, window.elementorFrontend);
